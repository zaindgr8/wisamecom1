...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 17913)), "/Users/zainulabideen/Downloads/_Software Journey/PIAIC- 2023/Hackaton/ecom_Hackaton_2/ecommerce-app/app/studio/page.tsx"],
    ...
    const pages = ["/Users/zainulabideen/Downloads/_Software Journey/PIAIC- 2023/Hackaton/ecom_Hackaton_2/ecommerce-app/app/studio/page.tsx"];
    ...
    const originalPathname = "/studio/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 21442))
...
// EXTERNAL MODULE: ./sanity/env.ts
var env = __webpack_require__(1852);
;// CONCATENATED MODULE: ./sanity/schemas/product-schema.ts

const product = (0,sanity_lib_index_cjs/* defineType */.feb)({
    name: "product",
    title: "Products",
    type: "document",
    fields: [
...
/* harmony default export */ const sanity_config = ((0,sanity_lib_index_cjs/* defineConfig */.ZDM)({
    basePath: "/studio",
    projectId: env/* projectId */.Sx,
    dataset: env/* dataset */.gx,
    ...
    plugins: [
        ...
        (0,lib_index_cjs/* visionTool */.T)({
            defaultApiVersion: env/* apiVersion */.tW
        })
    ]
}));

;// CONCATENATED MODULE: ./app/studio/page.tsx
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/zainulabideen/Downloads/_Software Journey/PIAIC- 2023/Hackaton/ecom_Hackaton_2/ecommerce-app/app/studio/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [683,970,361,814,989,324,34], () => (__webpack_exec__(61019)));
